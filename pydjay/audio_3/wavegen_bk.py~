...
class WaveformGen(Gst.Element):
    ...
    def __init__(self, parent, num_data_points, new_data_point_cb, process_done_cb, *args, **kwargs):   
 ...
 #       self.srcpad.set_chain_function(self._sink_chain)
    ...
    def _sink_chain(self, pad, buf):
        ...
        try:
            assert res
            offset   = 0
            buffer_bytes = array.array(self.forms[self.stream_format], mapinfo.data)
