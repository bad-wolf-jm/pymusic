...
<XSlider>:
    canvas.before:
        ...
        BorderImage:
            ...
            size: (self.width, self.height) # if self.orientation == 'horizontal' else (37, self.height)
            source: 'atlas://pydjay/gui/images/resources/volume-slider-bg'
        Rectangle:
            pos: (self.value_pos[0] - 16, self.center_y - 17) if self.orientation == 'horizontal' else (self.center_x - 16, self.value_pos[1] - 16)
            size: (90, 26)
            source: 'atlas://pydjay/gui/images/resources/volume-slider-knob'
"""

class XSlider(Widget):
...
Factory.register('XSlider', XSlider)
