...
class Tickline_i(StencilView):
    ...
    def __init__(self, *args, **kw):
        ...
        super(Tickline_i, self).__init__(*args, **kw)
        self._touches = []
    ...
    def on_touch_down(self, touch):
        ...
        if not self.collide_point(x, y):
            return False
        if super(Tickline_i, self).on_touch_down(touch):
            return True
    ...
    def on_touch_move(self, touch):
        ...
        if collide and not touch.grab_current == self:
            if super(Tickline_i, self).on_touch_move(touch):
                return True
    ...
    def on_touch_up(self, touch):
        ...
        if not touch.grab_current == self:
            if super(Tickline_i, self).on_touch_up(touch):
                return True
...
def Tickline(*args, **kw):
    #print 
    return Tickline_i(ticks=[Tick()])

Factory.register('Tickline', Tickline)
