        ...
        BoxLayout:
            ...
            BoxLayout:
                ...
                Label:
                    ...
                    text_size: self.size
                    multiline: True
                    text: "Enter a name or a path for the playlist you wish to create."
                BoxLayout:
                    orientation: 'horizontal'
                    size_hint: 1, None
                    pos_hint: {'center_y': .5}
...
class CurrentSessionView(ModalView):
    ...
    def save_current_session(self, *a):
        foo = SaveCurrentSessionDialog(self)
        foo.open()

    def do_save_current_session(self):
        self._update_sl_track_count()
        self.short_list.focus()
        pass
