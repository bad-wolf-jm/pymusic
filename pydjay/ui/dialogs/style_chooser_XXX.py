...
class StyleChooser(ModalView):
    ...
    def open(self):
        super(StyleChooser, self).open()
        self.short_list.set_track_list(pydjay.bootstrap.get_all_styles())
    ...
    def dismiss(self):
        ...
        super(StyleChooser, self).dismiss()
...
Factory.register('StyleChooser', StyleChooser)
