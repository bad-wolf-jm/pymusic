...
class GenreChooser(ModalView):
    ...
    def open(self):
        super(GenreChooser, self).open()
        self.short_list.set_track_list(pydjay.bootstrap.get_all_genres())
        self.short_list.focus()

    def dismiss(self):
        super(GenreChooser, self).dismiss()
...
Factory.register('GenreChooser', GenreChooser)
