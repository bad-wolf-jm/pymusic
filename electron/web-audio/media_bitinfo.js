...
function getMediaInfo(path) {
    ...
    var fileSize = st.size;
    var offset = 0;

    mi.open_buffer_init(fileSize, offset);
    mi.open_buffer_continue(buffer, fileSize); // s3FileData.Body is a buffer
...
//console.log(getMediaInfo("/home/jalbert/sample.mp3"))
console.log(util.inspect(getMediaInfo("/home/jalbert/sample.mp3"), false, null))
