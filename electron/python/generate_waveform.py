...
if __name__ == '__main__':
    ...
    #     c.execute("SELECT db_music_cache, db_waveform_cache FROM settings")
    #     settings = c.fetchone()
    #     print settings
    #     c.execute("SELECT file_name, waveform FROM tracks WHERE id > 1768")
    #     data = c.fetchall()
    #     for track in data:
    #         last_time = 0
    #         mp3_path = os.path.join(settings['db_music_cache'], track['file_name'])
    #         wave_path = os.path.join(settings['db_waveform_cache'], track['waveform'])
    #         print mp3_path, wave_path
    #         generate(mp3_path, wave_path)
    #
