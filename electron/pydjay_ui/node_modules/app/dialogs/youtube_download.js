...
class YoutubeDownloadDialog extends Dialog {
    constructor(id, track, library, config) {
        super()
        this.setTitle("Track info")
        this.setStyle({width:'700px', height:"550px"})
        ...
        save_button.on("click", async () => {
            ...
            stream.on('info', (data) =>  {
                console.log(data)
                let { media } = data
                this.titleInput.setText(media.song)
                this.artistInput.setText(media.artist)
                this.albumInput.setText(media.album)
            });
        ...
        this.layout.append(downloadProgressLayout, false, true, 40)
