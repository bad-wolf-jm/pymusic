...
class TrackClipDialog extends Dialog {
    constructor(track, library, config) {
        ...
        this.setStyle({width:'1200px', height:"450px"})
        ...
        this.audio_player.on("stream-position", (pos) => {
            try {
                let p = pos.position / this.track.track.duration
                p = Math.max(p, 0.0)
                p = Math.min(p, 1.0)
                this.waveform.seekAndCenter(p)
            } catch (e) {
        ...
        this.waveform = new WaveformView(100, "black", "grey", true)
        ...
        let playLayout =  new BoxLayout("horizontal", {left:0, right:0, top:0, bottom:0, padding:10})
        ...
        playLayout.append(playButton, false, true, 30)
        ...
        this.layout.append(title, false, false, 30)
        ...
        this.layout.append(playLayout, false, true, 30)
