...
class YoutubeSearchDialog extends Dialog {
    constructor(library, config) {
        ...
        this._listview.on("tag-download-clicked", (id) => {
            let stream = ytdl(id, {
                quality: 'highestaudio',
                filter: 'audioonly',
            });
            stream.on("info", (infoData) => {
                let downloadDialog = new YoutubeDownloadDialog(id, stream)
                let { media, thumbnail_url } = infoData
                // console.log(infoData, thumbnail_url)
