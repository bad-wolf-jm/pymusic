...
class TagListView extends ClusteredListView {
    ...
    setupColumnRenderers() {
        ...
        this.addColumnRenderer(new TextRenderer({
            ...
            // editTag: "name",
            color: (obj) => {return "rgb(28,28,28)"},
            text: (obj) => {return `<b>${obj.title}</b><p style="margin-top: 2px; margin-bottom: 2px; white-space: normal !important; width: 450px; font-size: 9pt; line-clamp:2; text-align: justify">${obj.description}</p><p style="margin-top: 10px; margin-bottom: 0px; font-size: 9pt"><i>Published:</i> ${moment(obj.publishedAt).format("Y-MM-D")}</p>`}
        }))
...
class YoutubeSearchDialog extends Dialog {
    constructor(library, config) {
        ...
        this.setStyle({width:'700px', height:"800px"})
        ...
        // this.layout.append(text, false, false, 30)
