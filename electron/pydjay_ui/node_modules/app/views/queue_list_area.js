...
class ListPane extends EventDispatcher {
    constructor(name, numTracks, duration, listArea, tableBody, library) {
        ...
        this._library.queue.on("content-changed", async () => {
            await this.updateDimmedRows() //await this._library.unavailable.getTrackIds())
    ...
    async updateDimmedRows() {
        if (this._dimUnavailableRows) {
            ...
            let duplicates = []
            // console.log(duplicateQueueEntries)
            ...
            // console.log("foo", duplicateQueueEntries)
            // console.log("bar", duplicates)
            this.listArea.clearDimmedRows("duplicate")
