...
class MainPlayerView extends BoxLayout {
    constructor (track_list_model) {
        ...
        let timeRemainingBPMLayout = new BoxLayout('vertical', {top:5, bottom:2, padding: 2})
        ...
        // infoLayout.append(titleAndTimeLayout, true, true)
        ...
        playerLayout.append(titleLayout, true, true)
        playerLayout.append(timeRemainingBPMLayout, false, true, 75)
        playerLayout.append(new DOMElement('div'), false, true, 5)
        ...
        topLayout.append(this.playerStack, false, true, 600)
        topLayout.append(new DOMElement('div'), true, true)
        topLayout.append(new DOMElement('div'), false, true, 50)
