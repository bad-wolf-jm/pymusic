...
class DetailedTrackListView extends ClusteredListView {
    ...
    convert_track(track_element) {
        ...
        return {
            ...
            title: this.formatNull(metadata.title),
            artist: this.formatNull(metadata.artist),
            album: this.formatNull(metadata.album),
            genre: this.formatNull(metadata.genre),
            tags: metadata.tags,
            last_played: stats.last_played, 
            play_count: stats.play_count,
            duration: track.stream_end - track.stream_start,
            bpm: this.formatNull(track.bpm),
            loved: stats.loved,
            rating: stats.rating,
            obj:track_element
        }
