...
class TrackListAreaController extends EventDispatcher {
    constructor(library) { 
        ...
        this.tag_filter_dom.addEventListener("click", async () => {
            let tagPicker = new TagFilterPicker(document.getElementsByTagName("body")[0], {
                tags: Object.values(await this._library.tags.getAllObjects()),
            ...
            tagPicker.open(this.tag_filter_dom)
        })
        ...
        this._listview.on("row-tag-clicked", async (trackId, element) => {
            ...
            let tagPicker = new TagPicker(document.getElementsByTagName("body")[0], {
                tags: tags,
                tagList: Object.values(await this._library.tags.getAllObjects()),
                cancel: () => {
