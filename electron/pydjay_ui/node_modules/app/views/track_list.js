...
class TrackListView extends ClusteredListView {
    ...
    handleDragStart(e) {
        ...
        let trackObject = this._elements.getElementById(x.id)
        let track_element = trackObject.id 
    ...
    async handleDoubleClick(e) {
        let x = e.target.closest("tr")
        let trackObject = this._elements.getElementById(x.id)
        let track_id = trackObject.id
        this.dispatch("row-double-click", track_id)
    }

    handleClick(e) {
        let x = e.target.closest("tr")
        let trackObject = this._elements.getElementById(x.id)
        this.dispatch("row-click", track_id)
        this.selectRow(x.id)
    }
