...
const { Question } = require("ui/dialog/question")
class ContextMenu {
    constructor(playlist, model, library, display, window) {
        ...
        this.menu.append(new MenuItem({label: 'Edit...', click: async () => {
            ...
            let Q = this.window.queueListView
            let T = this.window.mainListView
...
class PlaylistListView extends ClusteredListView {
    constructor(scroller, elements, window) {
    ...
    handleContextMenu(e) {
        ...
        let menu = new ContextMenu(playlistObject, this.model, MDB, this, this.window)
        menu.popup()
    }
...
class PlaylistListPanel extends DOMElement {
    constructor(window) {
        ...
        scroller.domElement.classList.add("grid-table-scroller")
        scroller.setStyle({
            width: "100%",
            height: "100%"
        })
        ...
        elements.domElement.classList.add("grid-table")
        ...
        this.view = new PlaylistListView(scroller, elements, window)
