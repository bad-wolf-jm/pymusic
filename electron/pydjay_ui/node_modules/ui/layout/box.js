...
class BoxLayout extends DOMElement {
    ...
    layout() {
        let fixedHeight = 0
        // let paddingHeight = (this.children.length - 1) * this.paddingHeight
        // console.log(this.orientation, this.children.length, paddingHeight)
        let expandCount = 0
        ...
        let expandHeight = Math.floor((this.layoutHeight - fixedHeight) / expandCount)
        this.children.forEach((x) => {
            if (x.expand) {
                if (this.orientation == 'vertical') {
