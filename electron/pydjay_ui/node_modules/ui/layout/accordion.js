...
class AccordionLayout extends DOMElement {
    ...
    openPanel(panel) {
        ...
        this.headers[panel.domElement.id].collapsedIndicator.setText(`<i class="fa fa-minus"></i>`)
    }
    ...
    closePanel(panel) {
        ...
        let variableHeightPanels = this.getVariableHeightPanels()
        this._resizeVariableHeightPanels(variableHeightPanels, invariable_height, true)
        this.headers[panel.domElement.id].collapsedIndicator.setText(`<i class="fa fa-plus"></i>`)
    }
}
