...
class ApplicationWindow extends EventDispatcher {
    constructor() {
        ...
        this.addStyleFile(`${uiDirName}/css/theme.css`)
        this.addStyleFile(`${uiDirName}/css/icons.css`)
        this.addStyleFile(`${uiDirName}/css/style.css`)
        this.addStyleFile(`${uiDirName}/css/dialog.css`)
        this.addStyleFile(`${uiDirName}/css/layout.css`)
        this.addStyleFile(`${uiDirName}/css/button.css`)
        this.addStyleFile(`${uiDirName}/css/label.css`)
        this.addStyleFile(`${uiDirName}/css/labeled_input.css`)
        this.addStyleFile(`${uiDirName}/css/progressbar.css`)
        ...
        this.addStyleFile(`${uiDirName}/css/bubble.css`)
    }
