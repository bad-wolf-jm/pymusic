...
class SessionSaveDialog extends InputDialog {
    constructor(config) {
        ...
        this.name_input = this.makeInput()
        this.location_input = this.makeInput()
        this.address_input = this.makeInput()
