...
const { VerticalLayout } = require("ui/layout/vertical")
...
class TagEditDialog extends Dialog {
    constructor(config) {
        ...
        this.setStyle({width:'400px', height:"600px"})

        this.layout = new VerticalLayout({left:20, right:20, top:20, bottom:20, padding:10})
        ...
        dismiss_button.setStyle({width:"calc(50%)"})
        ...
        this.layout.append(text, false, true)
        this.layout.append(tagListScroller, true, true)
        this.layout.append(dismiss_button, false, false)
