...
class ObjectSetModel extends EventDispatcher {
    ...
    async _getElements() {
        let q = await this.c.getObjectById(this.l)
        if (q != undefined) {
            return q.elements
        } else {
            return {}
...
class TrackSetModel extends ObjectSetModel {
    constructor(db, collection, id) {
