...
const { PlaylistModel, QueryModel }   = require("./playlist.js")
...
class MusicDatabase extends EventDispatcher {
    constructor(name) {
        ...
        this.shortlisted_tracks = new PlaylistModel(this, this.state, "shortlist")
        this.unavailable_tracks = new PlaylistModel(this, this.state, "unavailable")
    }
    ...
    async getTracksByIds(id_array) {
        return await this.tracks.getObjectsByIds(id_array)
    }
