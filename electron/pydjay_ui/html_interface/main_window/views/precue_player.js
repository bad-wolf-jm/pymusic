...
class PrecuePlayerView extends EventDispatcher {
    constructor (track_list_model) {
        ...
        document.getElementById("precue-play-full-track").addEventListener('click', () => {
            this.controller.getPrelistenTrack() && this.controller.prelistenTrack(this.controller.getPrelistenTrack())
        })
        document.getElementById("precue-play-last-30-seconds").addEventListener('click', () => {
            this.controller.getPrelistenTrack() && this.controller.prelistenLast30Seconds(this.controller.getPrelistenTrack())
        })
        document.getElementById("precue-play-last-10-seconds").addEventListener('click', () => {
            this.controller.getPrelistenTrack() && this.controller.prelistenLast10Seconds(this.controller.getPrelistenTrack())
        })
